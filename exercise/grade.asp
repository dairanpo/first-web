...
.STYLE31 {font-size: 24px; font-weight: bold; color: #000066; }
#Layer6 {
	position:absolute;
	width:156px;
	height:500px;
...
<body onLoad="MM_preloadImages('../image/qyjs1.gif','../image/jxzy1.gif','../image/kfzy1.gif','../image/yjdt1.gif','../image/jxdt1.gif')">
<div id="Layer50">
...
sql="select * from test1grade where title='"&title&"'  and number='"&number&"'"
...
<%else%>
  ...
  <div id="Layer17">考生：
    <%response.write rs("nam")%></div>
  <div id="Layer18">
    <table width="523" height="394" border="0">
      <tr>
        <td width="449">总得分（满分100分）：</td>
        <td width="195"><%response.write rs("grade")%></td>
      </tr>
      <tr>
        <td>第1题得分：</td>
        <td><%response.write rs("ti1g")%></td>
      </tr>
      <tr>
        <td>第2题得分：</td>
        <td><%response.write rs("ti2g")%></td>
      </tr>
      <tr>
        <td>第3题得分：</td>
        <td><%response.write rs("ti3g")%></td>
      </tr>
      <tr>
        <td>第4题得分：</td>
        <td><%response.write rs("ti4g")%></td>
      </tr>
      <tr>
        <td>第5题得分：</td>
        <td><%response.write rs("ti5g")%></td>
      </tr>
      <tr>
        <td>第6题得分：</td>
        <td><%response.write rs("ti6g")%></td>
      </tr>
      <tr>
        <td>第7题得分：</td>
        <td><%response.write rs("ti7g")%></td>
      </tr>
      <tr>
        <td>第8题得分：</td>
        <td><%response.write rs("ti8g")%></td>
      </tr>
      <tr>
        <td>第9题得分：</td>
        <td><%response.write rs("ti9g")%></td>
      </tr>
      <tr>
        <td>第10题得分：</td>
        <td><%response.write rs("ti10g")%></td>
      </tr>
      <tr>
        <td>第11题得分：</td>
        <td><%response.write rs("ti11g")%></td>
      </tr>
      <tr>
        <td>第12题得分：</td>
        <td><%response.write rs("ti12g")%></td>
      </tr>
      <tr>
        <td>第13题得分：</td>
        <td><%response.write rs("ti13g")%></td>
      </tr>
      <tr>
        <td>第14题得分：</td>
        <td><%response.write rs("ti14g")%></td>
      </tr>
      <tr>
        <td>第15题得分：</td>
        <td><%response.write rs("ti15g")%></td>
      </tr>
      <tr>
        <td>第16题得分：</td>
        <td><%response.write rs("ti16g")%></td>
      </tr>
      <tr>
        <td>第17题得分：</td>
        <td><%response.write rs("ti17g")%></td>
      </tr>
      <tr>
        <td>第18题得分：</td>
        <td><%response.write rs("ti18g")%></td>
      </tr>
      <tr>
        <td>第19题得分：</td>
        <td><%response.write rs("ti19g")%></td>
      </tr>
      <tr>
        <td>第20题得分：</td>
        <td><%response.write rs("ti20g")%></td>
      </tr>
    </table>
    <p>&nbsp;</p>
...
<%end if%>
  <div id="Layer12">
    <table width="110" height="270" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
        <td><a href="../1/main.asp" target="main1" onClick="MM_nbGroup('down','group1','part1','../image/jxdt1.gif',1)" onMouseOver="MM_nbGroup('over','part1','../image/jxdt1.gif','',1)" onMouseOut="MM_nbGroup('out')"><img src="../image/jxdt2.gif" alt="" name="part1" border="0" id="part1" onload="" /></a></td>
      </tr>
      <tr>
