...
<div id="Layer8">
  ...
  <p class="STYLE3"><a href="shenqing.asp"></a></p>
  <div id="Layer19">
    <form name="form1" method="post" action="add.asp">
      <table width="560" height="267" border="0">
        <tr>
          <td width="111">申请实验室：</td>
          <td width="439"><label>
        ...
        <tr>
          <td>使用时间：</td>
          <td><input name="time1" type="text" id="time1"></td>
        </tr>
        <tr>
          <td>申请用途：</td>
          <td><label>
            <textarea name="reason1" cols="60" rows="5" id="reason1"></textarea>
          </label></td>
        </tr>
		<tr>
          <td>申请人：</td>
          <td><label>
            <input name="nam1" type="text" id="nam1" value="" size="50">
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
...
<div id="Layer6">
  <p>&nbsp;</p>
  <div id="Layer12">
    <div id="Layer14">当前位置：申请使用实验室</div>
