...
<div id="Layer6">
  <p>&nbsp;</p>
  <div id="Layer12">
    <div id="Layer14">当前位置：<a href="synr.asp">实验室</a>&gt;&gt;已处理实验室申请</div>
...
response.write "<BR> <p align='center' class='STYLE3'>暂时没有已处理申请" & allrows & "</p>"
response.end
  else
...
%>
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="776" align="center" ;">
    <tr> 
      ...
      <td width="154"><div align="left"><a href="del.asp?id=<%=rs("id")%>">删除</a></div></td>
      <% else %>
      <% end if %>     
    </tr>
  </table>
