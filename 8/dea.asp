...
if rs.eof then                                                    '如果到最后还没有和输入相同的则转到
     response.write "<script>alert('实验室使用申请已处理');onclick=history.go(-1)</script>"
...
<div id="Layer20">
<form name="form2" method="post" action="deal.asp?id=<%=rs("id")%>">
  <table width="508" height="388" border="1">
    <tr>
      <td width="133">申请的实验室：</td>
      <td width="317"><%response.write rs("name1")%></td>
    </tr>
    <tr>
      <td>申请的实验器材：</td>
      <td><%response.write rs("thing")%></td>
    </tr>
    <tr>
      <td>申请人：</td>
      <td><%response.write rs("nam1")%></td>
    </tr>
    <tr>
      <td>申请使用时间：</td>
      <td><%response.write rs("time1")%></td>
    </tr>
    <tr>
      <td>申请理由：</td>
      <td><%response.write rs("reason1")%></td>
    </tr>
    <tr>
      <td>申请的用户学号：</td>
    ...
    <tr>
      <td>申请的用户姓名：</td>
      <td><%response.write rs("nam")%></td>
    </tr>
	    <tr>
      <td>提申请交时间：</td>
      <td><%response.write rs("time2")%></td>
    </tr>
    <tr>
      <td>指导教师意见：</td>
      <td><table width="200">
...
<div id="Layer6">
  <p>&nbsp;</p>
  <div id="Layer12">
    <div id="Layer14">当前位置：<a href="synr.asp">实验室</a>&gt;&gt;<a href="undo.asp">实验室未处理申请</a>&gt;&gt;实验室申请处理</div>
