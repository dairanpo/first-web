...
<div id="Layer6">
  <p>&nbsp;</p>
  <div id="Layer12">
    <div id="Layer14">当前位置：<a href="synr.asp">实验室</a>&gt;&gt;实验室未处理申请</div>
...
<div id="Layer8">
  ...
  ok="0"
       ...
       sql="select * from content where ok='"&ok&"' order by id DESC  "
...
response.write "<BR> <p align='center' class='STYLE3'>暂时没有未处理申请" & allrows & "</p>"
response.end
  else
...
%>
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="776" align="center" ;">
    <tr> 
      ...
      <td width="154"><div align="left"><a href="dea.asp?id=<%=rs("id")%>">立即处理</a></div></td>
      <% else %>
      <% end if %>     
    </tr>
  </table>
