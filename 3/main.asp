...
<body onLoad="MM_preloadImages('../image/kfzy1.gif','../image/yjdt1.gif','../image/jxdt1.gif','../image/qyjs1.gif','../image/jxzy2.gif')">
<div id="Layer50">
...
<div id="Layer6">
  <div id="Layer9">
    <div id="Layer14">当前位置：教学资源&gt;&gt;</div>
  </div>
  <p>&nbsp;</p>
  <div id="Layer12">
    <table width="110" height="270" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
        <td><a href="../1/main.asp" target="main1" onClick="MM_nbGroup('down','group1','part1','../image/jxdt2.gif',1)" onMouseOver="MM_nbGroup('over','part1','','',1)" onMouseOut="MM_nbGroup('out')"><img src="../image/jxdt2.gif" alt="" name="part1" border="0" id="part1" onload="MM_nbGroup('init','group1','part1','../image/jxdt1.gif',1)" /></a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><a href="../3/main.asp" target="main1" onClick="MM_nbGroup('down','group1','part3','../image/jxzy2.gif',1)" onMouseOver="MM_nbGroup('over','part3','','',1)" onMouseOut="MM_nbGroup('out')"><img name="part3" src="../image/jxzy1.gif" border="0" alt="" onload="" /></a></td>
      </tr>
      <tr>
...
%>
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="723" align="center" style="background-color: #b9d8f3;">
    <tr> 
      <td width="481" background="bg.gif" bgcolor="#B9D8F3" >

         <span class="STYLE6">
           <a class="STYLE6" href="read.asp?title=<%=rs("title")%>" target="main1">
             <img src="../image/d1.gif" width="10" height="10" border="0"><%=clearHTMLCode(rs("title"))%>
           </a>           
         </span>
        
      </td>
      <td width="227" background="bg.gif" bgcolor="#B9D8F3" ><span class="STYLE2"><%=clearHTMLCode(rs("time1"))%></span>
...
%>
    ...
    %>
      ...
      </strong><a href="main.asp?page=<%=page+1%>">下一页</a>
      <%else%>
