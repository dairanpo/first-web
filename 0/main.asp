...
<div id="Layer6">
  <div id="Layer14">当前位置：教学视频&gt;&gt;</div>
  <p>&nbsp;</p>
  <div id="Layer12">
    <table width="110" height="270" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
        <td><a href="../1/main.asp" target="main1" onClick="MM_nbGroup('down','group1','part1','../image/jxdt1.gif',1)" onMouseOver="MM_nbGroup('over','part1','','',1)" onMouseOut="MM_nbGroup('out')"><img src="../image/jxdt2.gif" alt="" name="part1" border="0" id="part1" onload="" /></a></td>
      </tr>
      <tr>
