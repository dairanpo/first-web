...
<body onLoad="MM_preloadImages('../image/jxzy1.gif','../image/kfzy1.gif','../image/jxdt1.gif','../image/qyjs1.gif','../image/yjdt2.gif')">
<div id="Layer50">
...
<div id="Layer6">
  ...
  <div id="Layer12">
    <table width="110" height="270" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><a href="../5/main.asp" target="main1" onClick="MM_nbGroup('down','group1','part5','../image/yjdt2.gif',1)" onMouseOver="MM_nbGroup('over','part5','','',1)" onMouseOut="MM_nbGroup('out')"><img name="part5" src="../image/yjdt1.gif" border="0" alt="" onload="" /></a></td>
      </tr>
    </table>
  </div>
</div>
